...
public class User implements Serializable {
    ...
    private Integer id;
    @Excel(name = "姓名",orderNum = "3",isImportField = "true_st",needMerge=true)
    private String name;

    private String password;

    @Excel(name = "电话",orderNum = "4",isImportField = "true_st",needMerge=true)
    private String phone;

    @Excel(name = "车牌号",orderNum = "5",isImportField = "true_st",needMerge=true)
